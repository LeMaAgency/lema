			...
			<div class="wrap_md">
				<div class="main_info iblock max-form-block">
					...
					<form id="registraion-page-form" method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data" >
						...
						<?}?>
						<?if(COption::GetOptionString("aspro.digital", "SHOW_LICENCE", "N") == "Y"):?>
							<div class="form-group animated-labels bg-color">
								<div class="wrap_md">
									<div class="iblock label_block">
										<div class="licence_block bx_filter">
											<input type="checkbox" id="licenses_popup" name="licenses_popup" <?=($arTheme["SHOW_LICENCE"]["DEPENDENT_PARAMS"]["LICENCE_CHECKED"]["VALUE"] == "Y" ? "checked" : "");?> required value="Y">
