									...
									<div class="foot">
										...
										<?if($bOrderButton):?>
											...
											<?if($bOrderButton && !$bOrderViewBasket):?>
												<span class="btn btn-default pull-left animate-load" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['aspro_digital_form']['aspro_digital_order_product'][0]?>" data-product="<?=$arItem['NAME']?>" data-name="order_product"><?=(strlen($arParams['S_ORDER_PRODUCT']) ? $arParams['S_ORDER_PRODUCT'] : GetMessage('S_ORDER_PRODUCT'))?></span>
											<?endif;?>
