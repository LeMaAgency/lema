...
<div class="contacts contacts-page-overmap  maxwidth-theme" itemscope itemtype="http://schema.org/Organization">
	<div class="contacts-wrapper">
		<div class="row">
			<div class="<?=($bUseFeedback ? 'col-md-3' : 'col-md-4')?>">
				<table>
					<tr>
			...
			<?if($bUseFeedback):?>
				<div class="col-md-3 ask-question">
					<button data-event="jqm" data-param-id="123" data-name="order_services" class="btn btn-default white wc"><i class="fa fa-question"></i> <span>Задать вопрос</span></button>
				</div>
			<?endif;?>
		</div>
	</div>
